...
#depends on game:menu/loadpacks
...
tellraw @a ["","\n","\n",{"text":"     Change Settings?","bold":true,"color":"aqua"},"\n",{"text":"     [","bold":true,"color":"white"},{"text":"✔","color":"dark_green","clickEvent":{"action":"run_command","value":"/function game:menu/changes"}},{"text":"]","bold":true,"color":"white"},{"text":"   [","bold":true,"color":"white"},{"text":"❌","color":"dark_red","clickEvent":{"action":"run_command","value":"/function game:menu/loadpacks"}},{"text":"]","bold":true,"color":"white"},"\n","\n"]
