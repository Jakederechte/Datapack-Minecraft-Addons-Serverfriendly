...
execute as @a run execute if entity @s[nbt={Inventory:[{Slot:-106b,id:"minecraft:furnace_minecart",tag:{display:{Name:'{"text":"Hand Furnace","color":"dark_gray","bold":true,"italic":false,"underlined":true}',Lore:['{"text":"A Furnace that melts all Items in your Inventory in the Background."}','{"text":"Put it in your Offhand to activate the Furnace."}']},Enchantments:[{}]}}]}] run scoreboard players set @s hfurnace-run 1
execute as @a run execute unless entity @s[nbt={Inventory:[{Slot:-106b,id:"minecraft:furnace_minecart",tag:{display:{Name:'{"text":"Hand Furnace","color":"dark_gray","bold":true,"italic":false,"underlined":true}',Lore:['{"text":"A Furnace that melts all Items in your Inventory in the Background."}','{"text":"Put it in your Offhand to activate the Furnace."}']},Enchantments:[{}]}}]}] run scoreboard players set @s hfurnace-run 0
